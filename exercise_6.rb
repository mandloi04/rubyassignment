class Aircraft
    ...
    def instance_create
        for i in 0..instances.size-1
            if i==0
                instances[i] = Aircraft(1,10)
            end
            if i==1
                instances[i] = Aircraft(13,16)
            end
            if i==2
                instances[i] = Aircraft(16,2)
            end
            if i==3
                instances[i] = Aircraft(19,8)
            end
            if i==4
...
class Boeing_747 < Aircraft
    ...
    for i in 0..instances.size-1
        if i==0
            instances[i] = Boeing_747.new(51,18,1,6)
        end
        if i==1
            instances[i] = Boeing_747.new(1,11,9,8)
        end
        if i==2
            instances[i] = Boeing_747.new(13,2,7,39)
        end
        if i==3
            instances[i] = Boeing_747.new(10,5,7,3)
        end
        if i==4
            instances[i] = Boeing_747.new(10,7,5,2)
        end
